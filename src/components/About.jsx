...
const About = () => {
  return (
    <section className="bg-slate-100 dark:bg-gray-800 py-10 transition-colors duration-300" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base text-gray-600 dark:text-gray-300 font-bold lg:text-lg">
